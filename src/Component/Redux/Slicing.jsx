// In this case, we have four reducers: addtoCart, RemoveItem
//  IncreaseQuantity, and DecreaseQuantity.
// 2>The addtoCart action creator is called with the product details 
// (like id, image, price, etc.) as the payload.
// This action is dispatched to the Redux store.
